...
FPS = 60 # Setting speed of running the game 
VEL = 5 
BULLET_VEL = 7
MAX_BULLETS = 3
SPACESHIP_WIDTH = 55
...
def red_handle_movement(keys_pressed,red):
    if keys_pressed[pygame.K_LEFT] and red.x - VEL > BORDER.x: #LEFT KEY
        red.x -= VEL
...
def main():
    ...
    while run:
        ...
        winner_text = ""
        if red_health <= 0:
              winner_text = "Yellow player WIN !"
        
        if yellow_health <= 0:
              winner_text = "Red player WIN !"
